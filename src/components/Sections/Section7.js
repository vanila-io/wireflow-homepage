      ...
      <div id="section7">
        <div className="sectionInner">
          <div className="col-md-12">
            <div className="col-md-6 feedbackBox feedbackBoxL">
              <p className="feedbackTxt">
                "Automatio is the best
                <strong>Kimono alternative</strong>. And we all know how good
                Kimono was"
              </p>
            ...
            <div className="col-md-6 feedbackBox feedbackBoxR">
              <p className="feedbackTxt">
                "Why build or pay for another
                <strong>scraper</strong>, when you can just
                <strong>click</strong>
                ?"
              </p>
              <div className="feedbackAuthor">
                <img
                  src={require("../../../public/img/homeAssets/jelena.png")}
                />
                <p>
          ...
          <div className="col-md-12">
            <div className="col-md-6 feedbackBox feedbackBoxL">
              <p className="feedbackTxt">
                "Seems that Automatio have much
                <strong>better workflow</strong> than Import.io."
              </p>
              <div className="feedbackAuthor">
                <img
                  src={require("../../../public/img/homeAssets/andrey.jpg")}
                />
                <p>
            ...
            <div className="col-md-6 feedbackBox feedbackBoxR">
              <p className="feedbackTxt">
                "Just think, almost
                <strong>any website</strong> into
                <strong>structured </strong>
                <strong>data</strong> like API, RSS, CSV ... That is limitless."
              </p>
              <div className="feedbackAuthor">
