...
class ContactForm extends React.Component {
  componentDidMount() {
    const postUrl = "http://45.79.171.117:4000/mail/submit";
  ...
  render() {
    ...
    return (
      <div id="contact" className="row rowContact">
        <h2 className="text-center enterFooter">
          We believe that
          <strong> success project</strong>
          <br />
          comes with success team
        </h2>
          ...
          <form className="contactForm" id="contact-form">
            ...
            <div className="checkbox checkbox-inline">
              <input
                ...
                type="checkbox"
              />
              <label htmlFor="checkbox1">ICO</label>
            </div>
            <div className="checkbox checkbox-inline">
              <input
                name="options"
                ...
                type="checkbox"
              />
              <label htmlFor="checkbox2">DAPP</label>
            </div>
            <div className="checkbox checkbox-inline">
              <input
                name="options"
                ...
                type="checkbox"
              />
              <label htmlFor="checkbox3">Growth Hacking</label>
            </div>
            <div className="form-group">
              <textarea
